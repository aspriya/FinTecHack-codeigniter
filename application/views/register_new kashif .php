                            ...
                            <form method="post" id="mf" name="myForm" action="<?php echo base_url() ?>index.php/RegistrationController/register">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="row inner-block">
                                        ...
                                        <div class="form-group col-lg-4">
                                            ...
                                            <input type="text" class="form-control" name="university_name" id="university_name" placeholder="" required="required">
                                        </div>

                                        <div class="form-group col-lg-4">
                                            <label for="member_count">Number of Members</label>
                                            <select class="form-control" name="member_count" id="member_count" onchange="memberRoll()" required="required">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="row inner-block">
                                        <div class="form-group col-lg-6">
                                            ...
                                            <input type="text" name="idea" class="form-control" id="idea" aria-describedby="emailHelp" placeholder="" required="true">
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label for="c_name" >Contact person's name</label>
                                            <input type="text" name="c_name" class="form-control" id="c_name" aria-describedby="fileHelp" required="true">
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label for="c_mail" >Contact person's e-mail</label>
                                            <input type="email" name="c_mail" class="form-control" id="c_mail" aria-describedby="fileHelp" required="true">
                                        </div>
                                        <div class="form-group col-lg-6">
                                            <label for="c_number" >Contact person's number</label>
                                            <input type="text" name="c_number" class="form-control" id="c_number" aria-describedby="fileHelp" required="true">
                                        </div>
                                        <div class="form-group col-lg-12">
                                            <label for="problem" >What is the problem that you intend solving ? </label>
                                            <textarea class="form-control" name="problem" id="problem" rows="3" required="true"></textarea>
                                        </div>
                                      <!--  <div class="form-group col-lg-12">
                                        ...
                                        <div class="form-group col-lg-12">
                                            ...
                                            <textarea class="form-control" name="solution" id="solution" rows="3" required="true"></textarea>
                                        </div>
                                        <div class="form-group col-lg-12">
                                         ...
                                         <!--   <textarea class="form-control" name="poc" id="poc" rows="3"></textarea> -->
                                            <select class="form-control" id="poc" name="poc" required="true">
                                        ...
                                        <div class="form-group col-lg-12">
                                            ...
                                            <textarea class="form-control" name="api" id="api" rows="3" required="true"></textarea>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="row inner-block">
                                        ...
                                        <div class="form-group col-lg-4">
                                            ...
                                            <input type="text" name="name-1" class="form-control" id="name-1" aria-describedby="emailHelp" placeholder="">
                                        </div>
                                        <div class="form-group col-lg-4">
                                            <label for="reg_no" >University Registration  / NIC / Passport Number</label>
                                            <input type="text" name="reg-1" class="form-control" id="reg-1" aria-describedby="emailHelp" placeholder="">
                                        </div>
                                        <div class="form-group col-lg-4">
                                            <label for="contact" >Contact Number</label>
                                            <input type="text" name="contact-1" class="form-control" id="contact-1" aria-describedby="emailHelp" placeholder="">
                                        </div>
                                        <div class="form-group col-lg-4">
                                            <label for="mail" >E-mail </label>
                                            <input type="email" name="mail-1" class="form-control" id="mail-1" aria-describedby="emailHelp" placeholder="">
                                        </div>
                                        <div class="form-group col-lg-4">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="row inner-block">
                                        ...
                                        <div class="form-group col-lg-4">
                                            <label for="name" >Name</label>
                                            <input type="text" name="name-2" class="form-control" id="name-2" aria-describedby="emailHelp" placeholder="">
                                        </div>
                                        <div class="form-group col-lg-4">
                                            <label for="reg_no" >University Registration / NIC / Passport Number</label>
                                            <input type="text" name="reg-2" class="form-control" id="reg-2" aria-describedby="emailHelp" placeholder="">
                                        </div>
                                        <div class="form-group col-lg-4">
                                            <label for="contact" >Contact Number</label>
                                            <input type="text" name="contact-2" class="form-control" id="contact-2" aria-describedby="emailHelp" placeholder="">
                                        </div>
                                        <div class="form-group col-lg-4">
                                            <label for="mail" >E-mail </label>
                                            <input type="email" name="mail-2" class="form-control" id="mail-2" aria-describedby="emailHelp" placeholder="">
                                        </div>
                                        <div class="form-group col-lg-4">
                                            <label for="meal">Meal</label>
