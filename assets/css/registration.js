...
'member_4_veg_non_veg': member_4_veg_non_veg, 'member_4_tshirt': member_4_tshirt, 'idea_title': idea_title, 'idea_description': idea_description, 'terms_accept': terms_accept},
        success:function(data){
            $("#submit_error").val() = "Successfully Registered";
        }
        });
    }
...
function hide_show_member_details(){
  ...
  function validate() {
    ...
    if(group_name_validity && university_validity && members_count_validity && leader_validity && member_2_validity && member_3_validity && member_4_validity && idea_title_validity && terms_accept_validity){
        return true;
    }
    else{
        return false;
...
function validate_leader(){
    ...
    else if(leader_university_id.trim() == "" || leader_university_id > 100){
...
function validate_member2(){
    ...
    else if(member_2_university_id.trim() == "" || member_2_university_id > 100){
...
function validate_member3(){
    ...
    if(members == "3"){
        ...
        else if(member_3_university_id.trim() == "" || member_3_university_id > 100){
...
function validate_member4(){
    ...
    if(members == "4"){
        ...
        else if(member_4_university_id.trim() == "" || member_4_university_id > 100){
